...
MONEDAS = (
    {'country': u'Chile', 'currency': 'UF', 'singular': u'UNIDAD DE FOMENTO', 'plural': u'UNIDADES DE FOMENTOS', 'symbol': u'UF','decimalsingular':u'','decimalplural':u''},
    {'country': u'Estados Unidos', 'currency': 'USD', 'singular': u'DÓLAR', 'plural': u'DÓLARES', 'symbol': u'US$','decimalsingular':u'Céntimo','decimalplural':u'Céntimos'},
    {'country': u'Europa', 'currency': 'EUR', 'singular': u'EURO', 'plural': u'EUROS', 'symbol': u'€', 'decimalsingular':u'Céntimo','decimalplural':u'Céntimos'},
    {'country': u'Chile', 'currency': 'CLP', 'singular': u'PESO CHILENO', 'plural': u'PESOS CHILENOS', 'symbol': u'','decimalsingular':u'Céntimo','decimalplural':u'Céntimos'},
...
def to_word(number, mi_moneda=None):
    ...
    if mi_moneda != None:
        try:
            ...
            moneda = list(filter(lambda x: x['currency'] == mi_moneda, MONEDAS)) #.next()
            moneda = moneda[0]
            #moneda = filter(igualmoneda, MONEDAS[0]) #.next()
